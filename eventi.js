...
.then(function(html)
{
    ...
    const text = $('#portletwrapper-', html);
    links = $('a',text);
   ...
   // write file
    fs.writeFile('eventi.json', jsonfile, function (err)
    {
        if (err)
        {
         throw err;
