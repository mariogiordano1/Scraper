...
.then(function(html)
{
    ...
    const text = $('#portletwrapper-706c6f6e652e7269676874636f6c756d6e0a636f6e746578740a2f756e696261342f726963657263612f646970617274696d656e74692f696e666f726d61746963612f646970617274696d656e746f2d64692d696e666f726d61746963610a646964617474696361', html);
    links = $('a',text)
    $(links).each(function(i, link)
    {
       ...
       if(_.isEqual(temp.Link, "http://www.uniba.it/didattica/tfa/offerta-formativa-tfa-2011-12/informatica"))
       {
           scrape.pop(temp);
       }
    })
   ...
   // write file
    fs.writeFile('didattica.json', jsonfile, function (err)
    {
        if (err)
        {
         throw err;
